 ...
 *
 * @access public
 * @param mixed   $name     (optional) .     (default: null)
 * @param mixed   $rank     (optional) .     (default: null)
 * @param mixed   $category (optional) . (default: null)
 * @param mixed   $country  (optional) .  (default: null)
 * @param int     $wins     (optional) .     (default: 0)
 * @param int     $losses   (optional) .   (default: 0)
 * @return void
 */
 ...
 * @param unknown $rank     (optional)
 * @param unknown $category (optional)
 * @param unknown $country  (optional)
 * @param unknown $wins     (optional)
 * @param unknown $losses   (optional)
 */
...
/**
 *
 * @param unknown $player1
 * @param unknown $player2
 * @param unknown $p1_score
 * @param unknown $p2_score
 * @param unknown $p1_rank_pre
 * @param unknown $p1_rank_post
 * @param unknown $p2_rank_pre
 * @param unknown $p2_rank_post
 * @param unknown $fight_date   (optional)
 * @param unknown $event        (optional)
 ...
 *
 * @param unknown $name       (optional)
 * @param unknown $event_date (optional)
 * @param unknown $shortcut   (optional)
 * @return unknown
 */
