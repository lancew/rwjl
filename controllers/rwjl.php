 ...
 *
 * @access public
 * @param unknown $event_region   (optional)
 * @param unknown $event_type     (optional)
 * @param unknown $event_name     (optional)
 * @param unknown $event_category (optional)
 * @return void
 */
function Get_file(
    $event_region = null,
 ...
 *
 * @access public
 * @param string  $name (optional) . (default: 'SOBIROV Rishod')
 * @return void
 */
